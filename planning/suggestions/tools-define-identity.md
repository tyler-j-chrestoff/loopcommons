...
**Status**: Fully promoted — ToolPackage interface (memory-packages), derived prompts (derived-prompts), content-addressed identity (attested-lineage). The full trajectory implements this suggestion.
