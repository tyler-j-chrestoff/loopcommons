...
describe('SubagentRegistry', () => {
  ...
  it('routes resume intent to resume subagent with get_resume tool', () => {
    ...
    expect(config.toolAllowlist).toEqual(['get_resume', 'memory_recall', 'memory_remember']);
  });
  ...
  it('routes project intent to project subagent with get_project tool', () => {
    ...
    expect(config.toolAllowlist).toEqual(['get_project', 'memory_recall', 'memory_remember']);
  });
