...
from .assets.tournament_consolidation import tournament_traces
from .assets.tournament_export import tournament_training_export
...
_assets = [consolidated_events, training_export, arena_traces, arena_training_export,
           tournament_traces, tournament_training_export]
